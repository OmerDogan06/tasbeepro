...
class AddCustomZikrScreen extends StatefulWidget {
  final Function(Zikr) onBack;
  const AddCustomZikrScreen({super.key, required this.onBack});
  ...
  void _addCustomZikr() async {
   ...
   Future.delayed(const Duration(seconds: 1),() {
    isLoading.value = false;
       widget.onBack(customZikr);

      Navigator.of(context.mounted ? context : Get.context!).pop();
   },);
    
    } catch (e) {
      isLoading.value = false;
      // Handle any errors
      debugPrint('Error adding custom zikr: $e');
    } 
  }
}
